...
python run.py train --lr 1e-5 --lr2 1e-4 -w 0.001 --modelname swap_senttr_g2g --batch_size 32 --buckets 5 \
         ...
         --input_graph --act_thr 200 --use_two_opts --main_path $MAIN_PATH --device 0
